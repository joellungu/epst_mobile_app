...
class MenuSecondaireClasseCours extends StatelessWidget {
  //
  double st = 15;
  double taille = 10;
  double pd = 15;
  ...
  MenuSecondaireClasseCours({Key? key}) : super(key: key);
  //
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("FORMATION ENSEIGNANTS SECONDAIRE"),
          centerTitle: true,
          bottom: TabBar(
            isScrollable: true,

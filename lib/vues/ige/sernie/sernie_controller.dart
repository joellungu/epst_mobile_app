...
class SernieController extends GetxController {
  ...
  //
  Future<bool> saveCommande(Map e) async {
    //
    Response rep = await requete.postE("sernie", e);
    //await requette.getE("mutuelle/all/demande");
  ...
  //
  Future<bool> updateCommande(Map e) async {
    //
    http.Response rep = await requete.putE("sernie", e);
    //await requette.getE("mutuelle/all/demande");
    if (rep.statusCode == 200 || rep.statusCode == 201) {
      //getAllDemande(province, district);
      print(rep.statusCode);

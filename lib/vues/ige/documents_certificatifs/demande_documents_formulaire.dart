...
class DemandeDocumentsFormulaire extends StatefulWidget {
  String? titre;
  //
  DemandeDocumentsFormulaire(this.titre, {Key? key}) : super(key: key);
  //
  @override
...
class _DemandeDocument extends State<DemandeDocumentsFormulaire> {
  //
      ...
      children: [
        ...
        Obx(() => i.value != 0
            ? Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(image: FileImage(File(img1!.path)))),
        ...
        ElevatedButton(
          onPressed: () async {
            if (nom.text.isEmpty) {
              ...
              messageErreur("Erreur", "Veuillez entrer un numéro de téléphone");
                    ...
                    return Material(
                      ...
                      child: Center(
                        child: Container(
                          ...
                          height: 300,
                          width: 270,
                          child: PayementMethode(formulaireD, 0.3, send,
                              types[type.value], "document"),
                        ),
                      ),
                    );
                  },
